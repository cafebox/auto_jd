/*
特别声明：
本脚本搬运自 https://github.com/whyour/hundun/blob/master/quanx/jx_nc.js  189 522
感谢 @whyour 大佬
...
const $ = new Env('京喜农场');
let notify = 'false'; // nodejs 发送通知脚本
...
function getAssistUser() {
    return new Promise(resolve => {
        try {
            $.get({url: `https://raw.githubusercontent.com/hajiuhajiu/jdsign1112/master/jxnc.json`, timeout: 10000}, async (err, resp, _data) => {
                try {
